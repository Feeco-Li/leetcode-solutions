...
# file/directory itself, all concatenated by `'/'s`. Using the above example, the
# **absolute path** to `file2.ext` is `"dir/subdir2/subsubdir2/file2.ext"`. Each
# directory name consists of letters, digits, and/or spaces. Each file name is of
...
# **Input:** input = "dir\n\tsubdir1\n\tsubdir2\n\t\tfile.ext"
# **Output:** 20
# **Explanation:** We have only one file, and the absolute path is "dir/subdir2/fi
# le.ext" of length 20.
#
# **Example 2:**
#
