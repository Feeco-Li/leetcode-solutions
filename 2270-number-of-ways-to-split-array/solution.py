...
# - Split nums at index 0. Then, the first part is [10], and its sum is 10. The se
# cond part is [4,-8,7], and its sum is 3. Since 10 >= 3, i = 0 is a valid split.
...
# .
# - Split nums at index 2. Then, the first part is [10,4,-8], and its sum is 6. Th
# e second part is [7], and its sum is 7. Since 6 < 7, i = 2 is not a valid split.
...
# - Split nums at index 1. Then, the first part is [2,3], and its sum is 5. The se
# cond part is [1,0], and its sum is 1. Since 5 >= 1, i = 1 is a valid split.
